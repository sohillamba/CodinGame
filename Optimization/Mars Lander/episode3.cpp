// Genetic algorithm
/*
  Changes from episode2.cpp:
    Changed approach to get the distance from the landing zone (
      priviously: direct distance which is wrong in episode 3
      in this: distance along the boundry
    )
    Fitness when going outside of the map is set to zero
    Number of genes increased
...
const int GENE_SIZE = 150;
const int POPULATION_SIZE = 100;
const int MAX_GENERATIONS = 500;
const float ELITISM_RATIO = 0.4; // 0.1 to 0.2;
...
TestCase testCase[7] = {
    ...
    TestCase(22, {{0,450}, {300,750}, {1000,450}, {1500,650}, {1800,850}, {2000,1950}, {2200,1850}, {2400,2000}, {3100,1800}, {3150,1550}, {2500,1600}, {2200,1550}, {2100,750}, {2200,150}, {3200,150}, {3500,450}, {4000,950}, {4500,1450}, {5000,1550}, {5500,1500}, {6000,950}, {6999,1750}}, 6500, 2600, -20, 0, 1000, 45, 0),
    TestCase(18, {{0,1800}, {300,1200}, {1000,1550}, {2000,1200}, {2500,1650}, {3700,220}, {4700,220}, {4750,1000}, {4700,1650}, {4000,1700}, {3700,1600}, {3750,1900}, {4000,2100}, {4900,2050}, {5100,1000}, {5500,500}, {6200,800}, {6999,600}}, 6500, 2000, 0, 0, 1200, 0, 0)
};
int currentTestCaseIndex = 6;
